...
class Review(TypedDict):
    ...
    key_features: Annotated[Optional[list[str]], "A list of key features mentioned in the review"]  
    ...
    reviewer: Annotated[Optional[str], "Write the name of person who has written the review if not available then write 'Anonymous'"]
